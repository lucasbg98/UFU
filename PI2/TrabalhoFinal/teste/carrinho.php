            ...
            <div class="col mb-2">
                <div class="row">
                    ...
                    $("#meuform").submit(function(event){
                        ...
                        var produtos = <?php $_SESSION["produtos"] ?>
                        $.ajax({
                            type: "POST",
                            url: "finalizacompra.php",
                            data: produtos,
                            success: function(responseData){
                                //$("#mensagemDiv").html("SUCESSO! Resposta do servidor: <br/>" + responseData);
                                $("#mensagemDiv1").addClass("alert alert-success").html(" " + responseData);
                                //window.location="logado.php?certo";
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 d-flex justify-content-center text-danger" id="mensagemDiv"></div>
                    <div class="col-sm-12 col-md-12 col-lg-12 d-flex justify-content-center text-success" id="mensagemDiv1"></div>
