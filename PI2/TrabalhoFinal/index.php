    ...
    <div class="container">
      <div class="row">
        ...
        <nav class="navbar navbar-dark bg-dark">
          <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarToggleExternalContent" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation" id = "cat">
          <span class="navbar-toggler-icon"></span>
          </button>
        </nav>
      </div>
      ...
      <form action="index.php" method="post" class="col-lg-4 col-md-6 mb-4" name="cat_<?php echo $values['categoria_fk'];?>">
          <div id = "divc" class="card h-100">
            ...
            <div class="card-body">
              ...
              <input type="hidden" id="categoria_fk" value="<?php echo $values['categoria_fk'];?>">
