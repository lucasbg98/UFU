...
<body>
    ...
    <div class="container">
        <div class="coluna col15">
            <form class="form-horizontal" id="meuform" action="../controller/controllerMaterial.php" method="post"><br>
                <fieldset>
                    <div class="panel panel-primary">
                        <div class="panel-heading" id="alinhamentoCentro">CADASTRO DE MATERIAL</div>
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="col-md-1 control-label" for="quant">Quantidade Recebida<h11>*</h11></label>  
                                    <div class="col-md-4">
