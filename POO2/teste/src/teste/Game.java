...
public class Game extends JFrame {
    ...
    //conexao segura com servidor
    private String criptografia = "!tictactoeSD!#$%&/()!";

    public Game() {
        initComponents();
        setSize(520, 600);
        setTitle("Jogo da Velha - Sistemas Distribuidos");
        setResizable(false);
  ...
  /*  private void messageKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_messageKeyPressed
    ...
    public void inicia() {
        ...
        port.setText("5000");
        nick.setText("");
        textArea.append("Trabalho de Sistemas Distribuidos.\n");
