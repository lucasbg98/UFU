...
public class RelatorioFornecedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        listaFornecedores = new javax.swing.JTextArea();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Relatório Fornecedores");
        ...
        listaFornecedores.setColumns(20);
        listaFornecedores.setRows(5);
    ...
    private void BAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BAtualizarActionPerformed
        ...
        List<Fornecedor> listaf = f.listFornecedores();
        for( Fornecedor f1 : listaf){
             listaFornecedores.append("Codigo: "+ f1.getCodigoF()+ "\n"+ "Nome: "+ f1.getNomeF()+ "\n"+ "\n\n"+ "-------------------------"+ "\n");
    ...
    private javax.swing.JTextArea listaFornecedores;
